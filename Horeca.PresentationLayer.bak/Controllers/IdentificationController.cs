...
namespace Horeca.PresentationLayer.Controllers
{
	public class IdentificationController : Controller
	{
		...
		//public IdentificationController(IConfiguration configuration)
		//{
		//	Configuration = configuration;
		//	BaseUrl = Configuration["IdentificationsAPI:Url"];
		//}
		...
		public async Task<ActionResult> Create([Bind ("Type", "Name", "VatNumber", "EmailAddress", "Description")] IdentificationModel task)
		{
			try
			{ 
